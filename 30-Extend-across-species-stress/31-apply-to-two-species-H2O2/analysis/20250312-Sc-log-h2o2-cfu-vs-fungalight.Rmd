...
# sample #10 is 6 mM treated, PI stained cell
p.exp_PI <- ggcyto(gs[[10]], aes(x = BL1.H, y = BL3.H), subset = "singlet") + 
  geom_hex(bins = 64) + 
...
# sample #9 is 6 mM treated, both SYTO9+PI stained cell
p.exp_FGL <- ggcyto(gs[[9]], aes(x = BL1.H, y = BL3.H), subset = "singlet") + 
  geom_hex(bins = 64) + 
  geom_gate(live.gate, colour = "gray20") + 
...
ggsave("../output/20250315-Sc-gating-strategy-example.png", p.exp,
