...
#ggsave("../output/20250307-gating-strategy-example.png", p.exp,
...
```{r}
cfu <- read_tsv("../input/20240225-0323-h2o2-Sc-Ca-CFU-raw.tsv") %>% 
...
# export the data for paper
write_tsv(dye_based, file = "../output/20250226-log-h2o2-fgl-estimate.tsv")
```
```
PI <- final %>% 
  dplyr::filter(Dye == "PI") %>% 
